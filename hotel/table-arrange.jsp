		...
		<div class="admin-content">
			<div class="admin-content-body">
				<div class="am-cf am-padding">
					<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">培训座位安排</strong></div>
				</div>
				...
				<div class="am-g">
					<div class="am-u-sm-12 am-u-md-5">
						<span class="desc">地点选择( 默认 二楼国瑞厅内 )</span>

						<div class="am-form-group">
				            <select name="change_place" id="change_place" data-am-selected="{btnSize: 'sm'}">
				              <!-- <option value="1">二楼国瑞厅内</option>
				              <option value="2">三楼宴会厅内</option>
				              <option value="3">三楼宴会厅外</option> -->
				            </select>
				         </div>
					</div>
				</div>
				<div class="am-g" id="table_arrange">
...
<script type="text/javascript" src="assets/js/table-arrange.js"></script>
<script type="text/javascript">
$(function(){
	var fisrtval = $("#change_place").val()
	// thead渲染
	getThead(fisrtval)
	//培训座位渲染
	gettableList(fisrtval)
